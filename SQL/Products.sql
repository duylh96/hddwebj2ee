...
",0, "/img/iphone-x.png","Iphone X",29000000,3,1,'2018/06/10',3);
...
•	Dung lượng pin:
2716 mAh, có sạc nhanh
",0, "/img/iphone-x-256gb.png","Iphone X-256",34000000,3,1,'2018/06/10',4);
...
",0, "/img/samsung-s8.png","Samsung S8",15000000,3,1,'2018/06/10',3);
...
",0, "/img/samsung-a8.png","Samsung A8",13000000,3,0,'2018/06/10',4);
...
•	Dung lượng pin:
2750 mAh
",0, "/img/iphone-6s-plus.png","Iphone 6SPLUS",12000000,3,0,'2018/06/10',4);
...
",0, "/img/sony-xperia-xz1.png","Sony Xperia",11000000,3,0,'2018/06/10',2);
...
•	Dung lượng pin:
3000 mAh, có sạc nhanh
",0, "/img/huawei-p20-pro.png","Huawei P20 Pro",7000000,3,0,'2018/06/10',3);
...
•	Dung lượng pin:
3400 mAh
",0, "/img/oppo-f7.png","Oppo F7",10000000,3,0,'2018/06/10',4);
...
•	Dung lượng pin:
3260 mAh
",0, "/img/vivo-v9.png","Vivo V9",8000000,3,2,'2018/06/10',5);
...
Dung lượng pin:	3800 mAh",0, "/img/nokia-7.png","Nokia 7",9000000,3,1,'2018/06/10',3);
...
•	Dung lượng pin:
3410 mAh
",0, "/img/htc-u.png","HTC U",3000000,3,1,'2018/06/10',1);
...
",0, "/img/apple-macbook-air.jpg","Macbook Air",19000000,1,2,'2018/06/10',5);
...
",0, "/img/asus-s510ua.jpg","Laptop Asus",16000000,1,1,'2018/06/10',5);
...
- Hệ điều hành: Win 10 Home",0, "/img/laptop-msi-gp63.jpg","Laptop MSI",34000000,1,1,'2018/06/10',4);
...
- Hệ điều hành: Win 10 Home",0, "/img/dell_xps13_silver.jpg","Laptop DELL",39000000,1,0,'2018/06/10',4);
...
- DVD-RW, Card reader, Led Keyboard
- Khối lượng: 2.12 Kg, pin 3 cell
- Hệ điều hành: Win 10 Home",0, "/img/laptop_lenovo_ideapad.jpg","Laptop Lenovo",15000000,1,1,'2018/06/10',3);
...
- DVD-RW, Card reader, Led Keyboard
- Khối lượng: 2.12 Kg, pin 3 cell
- Hệ điều hành: Win 10 Home",0, "/img/laptop_acer_nitro.jpg","Laptop Acer",23000000,1,0,'2018/06/10',2);
...
- Màn hình: 13.3 HD
- Trọng lượng: 1.5 Kg
- Hệ điều hành có sẵn: Free Dos",0, "/img/hp_probook_430.png","Laptop ACER",17000000,1,0,'2018/06/10',3);
...
- Trọng lượng: 0.94kg
- Hệ điều hành có sẵn: Free Dos",0, "/img/LG_13ZD.jpg","Laptop LG",17000000,1,1,'2018/06/10',4);
...
Chú ý: Dùng Adapter 5V-1A/2A để sạc cho thiết bị, Adapter trên 5V có thể gây ra hư hỏng cho thiết bị.",0, "/img/loa-bluetooth-cloud-fox.png","Loa Bluetooth",220000,4,1,'2018/06/10',3);
